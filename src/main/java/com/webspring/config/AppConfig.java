...
@ComponentScans(value = { @ComponentScan("com.webspring.dao"),
        @ComponentScan("com.webspring.service") })
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(User.class, Order.class);
